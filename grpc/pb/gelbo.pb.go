...
type GelboRequest struct {
	...
	Disconnect    string                 `protobuf:"bytes,15,opt,name=disconnect,proto3" json:"disconnect,omitempty"`
	Ifclientip    string                 `protobuf:"bytes,16,opt,name=ifclientip,proto3" json:"ifclientip,omitempty"`
	Ifproxy1Ip    string                 `protobuf:"bytes,17,opt,name=ifproxy1ip,proto3" json:"ifproxy1ip,omitempty"`
	Ifproxy2Ip    string                 `protobuf:"bytes,18,opt,name=ifproxy2ip,proto3" json:"ifproxy2ip,omitempty"`
	Ifproxy3Ip    string                 `protobuf:"bytes,19,opt,name=ifproxy3ip,proto3" json:"ifproxy3ip,omitempty"`
	Iflasthopip   string                 `protobuf:"bytes,20,opt,name=iflasthopip,proto3" json:"iflasthopip,omitempty"`
	Iftargetip    string                 `protobuf:"bytes,21,opt,name=iftargetip,proto3" json:"iftargetip,omitempty"`
	Ifhostip      string                 `protobuf:"bytes,22,opt,name=ifhostip,proto3" json:"ifhostip,omitempty"`
	Ifhost        string                 `protobuf:"bytes,23,opt,name=ifhost,proto3" json:"ifhost,omitempty"`
	Ifaz          string                 `protobuf:"bytes,24,opt,name=ifaz,proto3" json:"ifaz,omitempty"`
	Iftype        string                 `protobuf:"bytes,25,opt,name=iftype,proto3" json:"iftype,omitempty"`
...
func (x *GelboRequest) GetDisconnect() string {
	if x != nil {
		return x.Disconnect
	}
	return ""
...
const file_gelbo_proto_rawDesc = "" +
	"\n" +
	"\vgelbo.proto\x12\aelbgrpc\"\xac\x05\n" +
	...
	"\n" +
	"disconnect\x18\x0f \x01(\tR\n" +
	"disconnect\x12\x1e\n" +
	"\n" +
	"ifclientip\x18\x10 \x01(\tR\n" +
	"ifclientip\x12\x1e\n" +
	"\n" +
	"ifproxy1ip\x18\x11 \x01(\tR\n" +
	"ifproxy1ip\x12\x1e\n" +
	"\n" +
	"ifproxy2ip\x18\x12 \x01(\tR\n" +
	"ifproxy2ip\x12\x1e\n" +
	"\n" +
	"ifproxy3ip\x18\x13 \x01(\tR\n" +
	"ifproxy3ip\x12 \n" +
	"\viflasthopip\x18\x14 \x01(\tR\viflasthopip\x12\x1e\n" +
	"\n" +
	"iftargetip\x18\x15 \x01(\tR\n" +
	"iftargetip\x12\x1a\n" +
	"\bifhostip\x18\x16 \x01(\tR\bifhostip\x12\x16\n" +
	"\x06ifhost\x18\x17 \x01(\tR\x06ifhost\x12\x12\n" +
	"\x04ifaz\x18\x18 \x01(\tR\x04ifaz\x12\x16\n" +
	"\x06iftype\x18\x19 \x01(\tR\x06iftype\"\xdf\x01\n" +
	"\rGelboResponse\x12%\n" +
